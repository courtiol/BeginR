...
\begin{frame}[containsverbatim]{Facetting}
...
\begin{frame}[containsverbatim]{The aesthetic argument}
...
\begin{frame}[containsverbatim]{Using the aesthetic argument more}
...
\begin{frame}[containsverbatim]{Faceting}
