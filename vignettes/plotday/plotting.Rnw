...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile, t]{Text family}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]{Traditional graphics: Scatter plots}
You can add text and arrows:
<<scatter_gg_9>>=
max.value <- iris[iris$Petal.Length == max(iris$Petal.Length), ]
ggplot(data = iris, aes(x = Petal.Width, y = Petal.Length)) +
...
\begin{frame}[fragile]{ggplot: Box plots}
...
\begin{frame}[fragile]{ggplot: Histograms}
\vspace{0.5cm}
...
\begin{frame}[fragile]{ggplot: Bar plots}
\vspace{0.5cm}
