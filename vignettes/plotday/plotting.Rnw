...
plot(Petal.Length ~ Petal.Width, data = iris, pch = 3, col = iris$Species)
@
<<tidy=F, eval=F>>=
palette(c("red", "blue", "green"))
plot(Petal.Length ~ Petal.Width, data = iris, pch = 3, col = iris$Species)
...
palette(c("red", "blue", "green"))
plot(Petal.Length ~ Petal.Width, data = iris, pch = 3, col = iris$Species)
legend(x = 0.05, y = 7, c("setosa", "versicolor", "virginica"), pch = 3, col = c("red", "blue", "green"), bty = "n")
@
<<tidy=F, eval=F>>=
palette(c("red", "blue", "green"))
plot(Petal.Length ~ Petal.Width, data = iris, pch = 3, col = iris$Species)
legend(x = 0.05, y = 7, c("setosa", "versicolor", "virginica"),
       pch = 3, col = c("red", "blue", "green"), bty = "n")
@
\vspace{-1.25cm}
\begin{center}
...
palette(c("red", "blue", "green"))
plot(Petal.Length ~ Petal.Width, data = iris, pch = 3, col = iris$Species, ylim = c(0.8, 7.2))
...
diamond_stocks <- table(diamonds$cut)
barplot(diamond_stocks, cex.axis = 0.75, cex.names = 0.75)
@
<<tidy=F, eval=F>>=
diamond_stocks <- table(diamonds$cut)
barplot(diamond_stocks)
@
\vspace{-1cm}
\begin{center}
...
diamond_stocks <- table(diamonds$cut)
barplot(diamond_stocks, col = "white", cex.axis = 0.75, cex.names = 0.75)
@
<<tidy=F, eval=F>>=
barplot(diamond_stocks, col = "white")
@
\vspace{-1cm}
\begin{center}
...
\vspace{0.5cm}
<<aes_2, fig.width=8, fig.height=5,include=F>>=
par(mfrow = c(1, 2))
plot(Petal.Length ~ Petal.Width, data = iris,
     xlab = "Petal Width (cm)", ylab = "Petal Length (cm)",
     cex.lab = 1.5, cex.axis = 1.5, col.axis = "red")
boxplot(Petal.Length ~ Species, data = iris, col = "grey",
        cex.lab = 0.5, cex.axis = 1.5, col.axis = "red")
par(mfrow = c(1, 1))
@
<<tidy=F, eval=F>>=
par(mfrow = c(1, 2))
...
\vspace{0.5cm}
<<aes_3, fig.width=8, fig.height=5,include=F>>=
par(mfrow = c(1, 2), family = "serif")
plot(Petal.Length ~ Petal.Width, data = iris,
     xlab = "Petal Width (cm)", ylab = "Petal Length (cm)",
     cex.lab = 1.5, cex.axis = 1.5, col.axis = "red")
boxplot(Petal.Length ~ Species, data = iris, col = "grey",
        cex.lab = 0.75, cex.axis = 1.5, col.axis = "red")
...
<<aes_4, fig.width=8, fig.height=5,include=F>>=
...
\vspace{0cm}
\begin{center}
\includegraphics[width=0.55\linewidth]{./figure/aes_4-1.pdf}
\end{center}
\end{frame}
...
\vspace{0cm}
\begin{center}
\includegraphics[width=0.4\linewidth]{./figure/scatter_gg_4-1.pdf}
\end{center}
\end{frame}
...
ggplot(data = iris, mapping = aes(x = Petal.Width, y = Petal.Length)) +
  geom_point(aes(col = Species), shape = 3, size = 3)+
  theme(legend.position = "none")+
  geom_segment(aes(x = max.value$Petal.Width - 0.25,
                   xend = max.value$Petal.Width, y = max.value$Petal.Length,
                   yend = max.value$Petal.Length), size = 2,
               arrow = arrow(length = unit(0.5, "cm")))+
  geom_text(aes(x = max.value$Petal.Width - 0.3, y = max.value$Petal.Length, label = "Max"))
@
<<tidy=F, eval=F>>=
max.value <- iris[iris$Petal.Length == max(iris$Petal.Length), ]
ggplot(data = iris, mapping = aes(x = Petal.Width, y = Petal.Length)) +
  ...
  geom_segment(aes(x = max.value$Petal.Width - 0.25,
                   ...
                   yend = max.value$Petal.Length), size = 2, arrow = arrow(length = unit(0.5, "cm")))+
  geom_text(aes(x = max.value$Petal.Width - 0.3, y = max.value$Petal.Length, label = "Max"))
@
\vspace{0cm}
\begin{center}
...
ggplot(iris, aes(x = Petal.Length))+
  geom_histogram(binwidth = 0.5, col = "black", fill = "grey")
@
<<tidy=F, eval=F>>=
ggplot(iris, aes(x = Petal.Length))+
  geom_histogram(binwidth = 0.5, col = "black", fill = "grey")
