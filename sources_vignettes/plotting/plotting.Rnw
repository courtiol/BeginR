...
data_processed <- full_join(deaths_processed, pop_processed) %>%
...
\section{Plotting with \texttt{ggplot}}
\subsection{introduction}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]{\texttt{ggplot}: introduction}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile, t]{How to learn \texttt{ggplot} on your own?}
\begin{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile, t]{\texttt{ggplot}: introduction}
Overall structure of a \texttt{ggplot} call:
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile, t]{\texttt{ggplot}: scatter plots}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile, t]{\texttt{ggplot}: box plots}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile, t]{\texttt{ggplot}: histograms}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile, t]{\texttt{ggplot}: bar plots}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile, t]{Combining plots}
Combining plots is less straightforward in \texttt{ggplot}\dots
\vfill
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile, t]{Modifying typefaces}
Unlike traditional graphics, in \texttt{ggplot} you can easily change the typeface of individual elements in theme:
...
\texttt{ggplot} also has a number of preset themes that you can use:
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile, t]{\texttt{ggplot}: Exporting}
<<tidy=F, eval=F>>=
?ggsave
@
\vspace{0.5cm}
...
There are a few other plot types in \texttt{ggplot} that are worth looking at (check the cheatsheet!):
\begin{itemize}
...
\vfill
\pause
But the true force of having developed something as modular as \texttt{ggplot} is that there are many more packages each week providing \texttt{ggplot} extensions!
\vfill
A few random examples of \texttt{ggplot} extensions:
\begin{itemize}
...
<<>>=
ggplot(data = data_processed, mapping = aes(y = rel_Deaths, x = Year)) + geom_area()
@
\end{frame}
...
deaths_processed_all <- deaths_UK %>% group_by(Year, Age_cat) %>% summarize(tot_Deaths = sum(Deaths))
pop_processed <- population_UK %>% group_by(Year) %>% summarize(tot_Pop = sum(Pop)) ## as before
data_processed_all <- full_join(deaths_processed_all, pop_processed) %>% mutate(rel_Deaths = 1000*tot_Deaths/tot_Pop)

ggplot(data = data_processed_all, mapping = aes(y = rel_Deaths, x = Year, fill = Age_cat)) + geom_area()
@
\end{frame}
...
\section{Conclusion: traditional graphics vs. \texttt{ggplot}}
