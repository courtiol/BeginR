...
\item show you what are the main principles of the \r \ language
...
You should:
\begin{itemize}
\item accept that at the beginning it will be a little too abstract
\item focus on the big picture (understand the logic, consider the long term gains)
