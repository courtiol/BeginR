...
(my_matrix4 <- matrix(data = c(1:3, NA, 5:10), ncol = 2, nrow = 5))
@
\end{frame}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]{Using \texttt{dplyr} to merge datasets}
You can also use \texttt{left\_join()} to merge datasets sampled at different scales (e.g. daily and annual level; species and individual level).
\vfill
<<left join>>=
flower_quality <- data.frame(Species = c("setosa", "versicolor", "virginica"),
                             Quality = c("High", "Medium", "Low"))
my_df4 <- left_join(my_df3, flower_quality, by = "Species")
my_df4
@
\end{frame}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]{What are tibbles?}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]{From tibbles to data frames and back}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]{How to influence the display of tibbles?}
