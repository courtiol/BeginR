...
build: clean
	mkdir -p inst/doc
	mkdir vignettes
	cp sources_vignettes/introduction/*.pdf* sources_vignettes/usingdata/*.pdf* sources_vignettes/plotting/*.pdf* sources_vignettes/programming/*.pdf* sources_vignettes/statistics/*.pdf* sources_vignettes/cheatsheets/*.pdf* vignettes ## for linux add -u after cp
	cp sources_vignettes/introduction/*.Rnw sources_vignettes/usingdata/*.Rnw sources_vignettes/plotting/*.Rnw sources_vignettes/programming/*.Rnw sources_vignettes/statistics/*.Rnw inst/doc ## for linux add -u after cp
